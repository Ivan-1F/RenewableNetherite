...
public class NetheriteBootsRenewableRecipe extends SpecialCraftingRecipe {
    public NetheriteBootsRenewableRecipe(Identifier id) {
        super(id);
    }
    ...
    public boolean matches(CraftingInventory inv, World world) {
        ...
        if (!RenewableNetherite.check(inv, 4, Items.DIAMOND_BOOTS)) return false;
    ...
    public ItemStack craft(CraftingInventory inv) {
        ...
        ItemStack result = Items.NETHERITE_BOOTS.getDefaultStack();
        if (tool.hasTag()) {
    ...
    public RecipeSerializer<?> getSerializer() {
        return RenewableNetherite.netheriteBootsRenewableRecipe;
    }
}
